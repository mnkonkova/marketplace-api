...
var fallbackCategories = []CategoryRef{
	...
	{"director", "Режиссёр", "концепция, кастинг, режиссура на площадке, ведение проекта от идеи до сдачи"},
	...
	{"ads_seo", "Таргетолог / SEO", "таргет, таргетолог, performance, контекстная реклама и SEO. Meta Ads / ВК Реклама / Яндекс Директ / Google Ads"},
